...
public static final String CREATE_RECHNUNG = "CreateRechnung"; // Jasmin: Implementierung fehlt noch
public static final String CREATE_RECHNUNGSZEILE = "CreateRechnungszeile"; // Jasmin: Implementierung fehlt noch

public static final String DELETE_KONTAKT = "DeleteKontakt"; // Jasmin: Implementierung fehlt noch
public static final String DELETE_RECHNUNG = "DeleteRechnung"; // Jasmin: Implementierung fehlt noch
public static final String DELETE_RECHNUNGSZEILE = "DeleteRechnungszeile"; // Jasmin: Implementierung fehlt noch
